...
public class Assert {
   ...
   */
  static public void assertTrue(Supplier<String> message, boolean condition) {
    if (!condition) {
      fail(message);
    }
  }
   ...
   * @param condition condition to be checked
   */
  static public void assertFalse(Supplier<String> message, boolean condition) {
   ...
   * @see AssertionError
   */
  static public void fail(Supplier<String> message) {
  ...
  static private String getMessage(Supplier<String> message) {
    return Optional.ofNullable(message).map(msg -> msg.get()).orElse("");
  }
   ...
   */
  static public void assertEquals(Supplier<String> message, Object expected,
                                  Object actual) {
    if (equalsRegardingNull(expected, actual)) {
      return;
    } else if (expected instanceof String && actual instanceof String) {
      String cleanMessage = getMessage(message);
   ...
   */
  static public void assertNotEquals(Supplier<String> message, Object first,
                                     Object second) {
  ...
  private static void failEquals(Supplier<String> message, Object actual) {
    fail(() -> "Values should be different. " + formatMessage(message, "Actual: " + actual));
  }
   ...
   * @param second the value to check against <code>first</code>
   */
  static public void assertNotEquals(Supplier<String> message, long first, long second) {
   ...
   * considered equal.
   */
  static public void assertNotEquals(Supplier<String> message, double first,
   ...
   * considered equal.
   */
  static public void assertEquals(Supplier<String> message, double expected,
   ...
   * considered equal.
   */
  static public void assertEquals(Supplier<String> message, float expected,
   ...
   */
  static public void assertEquals(Supplier<String> message, long expected, long actual) {
  ...
  /**
   * @deprecated Use
   *             <code>assertEquals(Supplier<String> message, double expected, double actual, double delta)</code>
   *             instead
   */
  @Deprecated
  static public void assertEquals(Supplier<String> message, double expected,
   ...
   */
  static public void assertNotNull(Supplier<String> message, Object object) {
   ...
   * @param object Object to check or <code>null</code>
   */
  static public void assertNull(Supplier<String> message, Object object) {
    if (object == null) {
      return;
    }
  ...
  static private void failNotNull(Supplier<String> message, Object actual) {
   ...
   */
  static public void assertSame(Supplier<String> message, Object expected, Object actual) {
    if (expected == actual) {
      return;
    }
   ...
   */
  static public void assertNotSame(Supplier<String> message, Object unexpected,
                                   Object actual) {
  ...
  static private String formatMessage(Supplier<String> message, String expectations) {
    String msg = getMessage(message);
    return (msg.isEmpty() ? "" : msg + " ") + expectations;
  }

  static private void failSame(Supplier<String> message) {
    fail(() -> formatMessage(message, "expected not same"));
  }

  static private void failNotSame(Supplier<String> message, Object expected,
                                  Object actual) {
    fail(() -> formatMessage(message, "expected same:<" + expected + "> was not:<" + actual + ">"));
  }

  static private void failNotEquals(Supplier<String> message, Object expected,
                                    Object actual) {
